...
export const translations = {
  ru: {
    ...
    'me.pushTest': 'Отправить тестовое',
    'me.pushTestSent': 'Отправлено — уведомление придёт через пару секунд',
    'me.pushTestFailed': 'Не дошло. Проверьте разрешения и попробуйте переподписаться',
    ...
    // Биллинг: paywall + блок «Подписка» в /me (product/ARCHITECTURE_PAYMENTS.md)
    'billing.paywallTitle': 'AI Trainer — по подписке',
    'billing.paywallSubtitle': 'Личный AI-тренер: программа под тебя, ответы на вопросы в зале, разбор тренажёров по фото и трекинг прогресса',
    'billing.planWeek': 'Неделя',
    'billing.planMonth': 'Месяц',
    'billing.planLifetime': 'Навсегда',
    'billing.perWeek': 'за неделю',
    'billing.perMonth': 'за месяц',
    'billing.oneTime': 'разовый платёж',
    'billing.featured': 'выгодно',
    'billing.payCta': 'Оплатить {{price}}',
    'billing.processing': 'Проверяем оплату…',
    'billing.granted': 'Оплата прошла — доступ открыт!',
    'billing.noMethods': 'Способы оплаты пока не подключены. Загляни чуть позже',
    'billing.methodTitle': 'Способ оплаты',
    'billing.method.stars': 'Telegram Stars',
    'billing.method.yookassa': 'Карта (ЮKassa)',
    'billing.method.tribute': 'Подписка в Telegram (Tribute)',
    'billing.method.paddle': 'Карта (Paddle)',
    'billing.method.mock': 'Тестовая оплата (dev)',
    'billing.promoToggle': 'У меня есть промокод',
    'billing.promoPlaceholder': 'Промокод',
    'billing.promoApply': 'Применить',
    'billing.promoFreeApplied': 'Промокод активирован: {{days}} дней бесплатно',
    'billing.promoDiscountApplied': 'Скидка {{pct}}% применится при оплате',
    'billing.error.PROMO_NOT_FOUND': 'Промокод не найден или отключён',
    'billing.error.PROMO_EXPIRED': 'Срок действия промокода истёк',
    'billing.error.PROMO_LIMIT_REACHED': 'Лимит активаций промокода исчерпан',
    'billing.error.PROMO_ALREADY_USED': 'Этот промокод уже активирован',
    'billing.error.PROMO_WRONG_PLAN': 'Промокод действует на другой план',
    'billing.error.PROMO_MISCONFIGURED': 'Промокод настроен некорректно',
    'billing.error.METHOD_UNAVAILABLE': 'Этот способ оплаты недоступен',
    'billing.error.generic': 'Не получилось. Попробуйте ещё раз',
    'billing.subTitle': 'Подписка',
    'billing.subActiveUntil': 'Активна до {{date}}',
    'billing.subLifetime': 'Навсегда',
    'billing.subAutoRenew': 'Продлевается автоматически',
    'billing.subNoAutoRenew': 'Без автопродления',
    'billing.subInactive': 'Подписка неактивна',
    'billing.subProvider.promo': 'по промокоду',
    'billing.subProvider.admin': 'подарок',
    'billing.subProvider.mock': 'тестовая (dev)',
    'billing.subCancel': 'Отключить автопродление',
    'billing.subCancelTitle': 'Отключить автопродление?',
    'billing.subCancelText': 'Подписка доработает оплаченный период и не продлится. Возобновить можно в любой момент',
    'billing.subCancelConfirm': 'Отключить',
    'billing.subCanceled': 'Автопродление отключено',
    'billing.subCancelViaProvider': 'Подписка продлевается на стороне провайдера — отмена там же',
    'billing.subRenewCta': 'Продлить подписку',
    'billing.subBuyCta': 'Оформить подписку',
  },
}
