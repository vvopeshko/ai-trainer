...
const ruContent = {
  ...
  'EQ-HYP-006': { question: 'Как в силовых упражнениях полная амплитуда и частичные повторения в разных участках движения влияют на гипертрофию и силу в тренированной амплитуде?' },
