    ...
    return f"""      // МОК-ДАННЫЕ
      ...
      function buildMockProgram() {{
        ...
        return {{
          ...
          // Сохранённые программы пользователя (для экрана Library)
          savedPrograms: [
            {{
              id: 'ppl-arms',
              name: 'PPL + Arms',
            ...
            {{
              ...
              name: 'Split A/B',
              emoji: '💪',
              split: '2-дневный сплит (verх/низ)',
              daysPerWeek: 3,
              difficulty: 'Базовый',
              isActive: false,
              activatedDate: '2026-01-02',
              deactivatedDate: '2026-01-30',
              workoutsDone: 17,
              archived: true,
            }},
          ],
